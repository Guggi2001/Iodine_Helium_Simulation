function [ax,ay,az, E_pot] = add_partner_interaction(x,y,z, mass)
...
h= 0.0001;
E_pot = atom_interaction_potential(dr);

F = (E_pot - atom_interaction_potential(dr+h))/h;% force in eV/Angström
