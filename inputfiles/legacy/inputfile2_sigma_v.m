...
hard_sphere_collision_mode = 2; % 1: scattering rate, 2: scatter after traveling mean free path
...
geometric_scattering_crosssection_I = 12*2; %Angström^2;
