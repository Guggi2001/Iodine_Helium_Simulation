%% test run: same sigma^2 for neutral as braun thesis
% no hedft start
% no binding energy for ion
% two photon excitation initial velocity of neutral
...
partner_interaction = false; % iodine atoms interact in the ground state X potential
...
geometric_scattering_crosssection_Iplus = 2500;  %Angström^2; % ion pumpprobe sigma = v^-2
